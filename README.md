...
To write new RFID cards you have to place the RFID card on the scanner and use this https://github.com/netcrawler123/Rfid-attendance-system/tree/main/rfid_write_personal_data code to write the required information to the card
