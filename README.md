...
/nTo write new RFID cards you have to place the RFID card on the scanner and use [this](/rfid_write_personal_data/) code to write the required information to the card
